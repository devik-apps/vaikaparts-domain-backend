...
public class UsersApi {
  ...
  /**
   * Retrieve current authenticated user profile Returns the complete profile of the currently
   * authenticated user based on the Supabase JWT token provided in the request.
   *
  ...
  private ResponseSpec getCurrentUserRequestCreation() throws RestClientResponseException {
    ...
    ParameterizedTypeReference<GetCurrentUser200Response> localVarReturnType =
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public GetCurrentUser200Response getCurrentUser() throws RestClientResponseException {
    ParameterizedTypeReference<GetCurrentUser200Response> localVarReturnType =
        new ParameterizedTypeReference<>() {};
   ...
   * <p><b>401</b> - Missing or invalid authentication credentials
   *
   * @return ResponseEntity&lt;GetCurrentUser200Response&gt;
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseEntity<GetCurrentUser200Response> getCurrentUserWithHttpInfo()
