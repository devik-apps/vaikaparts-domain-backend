...
|------------- | ------------- | -------------|
| [**deleteProfilePhoto**](UsersApi.md#deleteProfilePhoto) | **DELETE** /users/me/profile-photo | Remove user profile photograph |
| [**getCurrentUser**](UsersApi.md#getCurrentUser) | **GET** /users/me | Retrieve current authenticated user profile |
| [**uploadProfilePhoto**](UsersApi.md#uploadProfilePhoto) | **POST** /users/me/profile-photo | Upload user profile photograph |
...
import com.devikapps.vaikaparts.client.api.UsersApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling UsersApi#deleteProfilePhoto");
...
Returns the complete profile of the currently authenticated user based on the Supabase JWT token provided in the request.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling UsersApi#uploadProfilePhoto");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
