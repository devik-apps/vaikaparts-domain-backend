...
import com.devikapps.vaikaparts.config.RabbitConf;
...
public class EventConf {
   ...
   * left. It republishes the message to the DLX exchange declared in {@link RabbitConf}, from where
   * it is routed to the DLQ.
   *
  ...
  public RepublishMessageRecoverer republishMessageRecoverer(
    ...
    return new RepublishMessageRecoverer(
        rabbitTemplate,
        String.format("%s.dlx", exchangeName),
        String.format("%s.dead", routingKey));
  }
